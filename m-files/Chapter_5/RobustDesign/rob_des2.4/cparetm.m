function cparetm(yy,ytxt,ttxt,sort_opt,opt,x,tx,index)

% CPARETM: Generate a Pareto diagram of correlation coef. (matrix version)
% ============================================================================
% cparetm(yy,[ytxt],[ttxt],[sort_opt],[opt],x,[tx],[index]);
% ----------------------------------------------------------------------------
...
%
% ----------------------------------------------------------------------------
% Example: cparetm(yy,'yname','Pareto corr. coef.',...
...
if all(yy==yy(1))
  message('cparetm','parameter yy constant')
end
