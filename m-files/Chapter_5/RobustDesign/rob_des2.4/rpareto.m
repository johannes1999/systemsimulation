function rpareto(yy,ytxt,ttxt,sort_opt,opt,...
...
% RPARETO: Generate a Pareto diagram of response surface coefficients
% ============================================================================
% rpareto(yy,[ytxt],[ttxt],[sort_opt],[opt],x1,tx1,...,x20,tx20)
% ----------------------------------------------------------------------------
...
%
% ----------------------------------------------------------------------------
% Example: rpareto(yy,'yname','Pareto resp.surf.',1,[1,1,1],...
...
if all(yy==yy(1))
  message('rpareto','parameter yy constant')
end
...
% **********************************************************************
x=[]; for k=1:npar, x=[x;eval(['x' int2str(k)])]; end
