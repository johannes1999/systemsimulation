function [xo,yo] = bar_v4(x,y,c)
%BAR_V4	Bar graph
%       *** Copy of BAR.M from MatLab 4.2c ***
%	BAR_V4(Y) draws a bar graph of the elements of vector Y.
%	BAR_V4(X,Y) draws a bar graph of the elements of vector Y at
...
%	is drawn.
%
%	[XX,YY] = BAR_V4(X,Y) does not draw a graph, but returns vectors
%	X and Y such that PLOT(XX,YY) is the bar chart.
%
%	See also STAIRS, HIST.
%
%	BAR_V4(X,'linetype') or BAR_V4(X,Y,'linetype') uses the plot linetype
